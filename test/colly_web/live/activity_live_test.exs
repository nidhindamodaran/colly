defmodule CollyWeb.ActivityLiveTest do
  ...
  @create_attrs %{description: "some description", name: "some name", visitors_count: 42}
  ...
  defp fixture(:activity) do
    {:ok, activity} = Collab.create_activity(@create_attrs)
    activity
  end
